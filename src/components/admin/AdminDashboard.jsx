        ...
        <div className="p-4 space-y-3 max-h-[500px] overflow-y-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            >
              ...
              {isSendingStudentEmails ? 'Sending...' : 'Send Email Reports'}
            </button>
            ...
            <button
              ...
              className="px-4 py-3 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-60 disabled:cursor-not-allowed text-white rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 shadow-md"
            >
              {isSendingWhatsApp ? <Loader2 size={16} className="animate-spin" /> : (
              ...
              {isSendingWhatsApp ? 'Sending...' : 'Send WhatsApp Reports'}
            </button>
